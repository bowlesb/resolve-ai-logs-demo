...
- Endpoints
  ...
  - **GET `/metrics`**: prometheus scrapes metrics for Grafana dash.
...
## 13x. Limitations and Possible Improvements
...
5. **Optimize Analyzer Service** - As mentioned above, it would be ideal to fix / replace the for loop in the Analyzer Service. 
---
